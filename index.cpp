...
void Casino::showMenu() {
  ...
  cout << "7. Si el número que cayo es par y el que escribió es impar, pierde su apuesta \n";
  cout << "8: El juego terminará cuando su saldo esté en 0 \n";
}
